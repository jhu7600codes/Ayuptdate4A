...
public abstract class SystemUtils {
    ...
    public static boolean hasBiometrics() {
        ...
        if (i >= 29) {
            BiometricManager m = SystemUtils$$ExternalSyntheticApiModelOutline1.m(ApplicationLoader.applicationContext.getSystemService(SystemUtils$$ExternalSyntheticApiModelOutline0.m()));
            if (m == null) {
                return false;
            }
            return i >= 30 ? m.canAuthenticate(255) == 0 : m.canAuthenticate() == 0;
        }
    ...
    public static File getFileFromBitmap(Bitmap bitmap) throws java.io.IOException {
