...
public class AppUtils {
    ...
    private static void logInternal(String str, Throwable th, int i) {
        ...
        String format = String.format("[%s] %s", stackTraceElement.getMethodName(), str);
        if (th != null) {
    ...
    public static boolean compareVersions(String str, String str2, String str3) {
        int compareVersionValues;
        compareVersionValues = compareVersionValues(str2, str3);
        str.getClass();
        switch (str) {
            case "<":
                return compareVersionValues < 0;
            case ">":
                return compareVersionValues > 0;
            case "<=":
                return compareVersionValues <= 0;
