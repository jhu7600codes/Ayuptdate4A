...
public abstract class DoubleTapUtils {
    ...
    public static int[] getDoubleTapIcons(boolean z) {
        if (!z) {
            return new int[]{R.drawable.msg_block, R.drawable.msg_reactions2, R.drawable.menu_reply, R.drawable.msg_copy, R.drawable.msg_forward, R.drawable.msg_saved, R.drawable.msg_repeat, R.drawable.msg_delete, R.drawable.msg_translate, R.drawable.msg_view_file};
        }
        return new int[]{R.drawable.msg_block, R.drawable.msg_reactions2, R.drawable.menu_reply, R.drawable.msg_copy, R.drawable.msg_forward, R.drawable.msg_edit, R.drawable.msg_saved, R.drawable.msg_delete, R.drawable.msg_translate};
    }

    public static int getActionId(int i, boolean z) {
        int sanitizeSetting = i == 10 ? 9 : sanitizeSetting(i);
        if (z) {
            switch (sanitizeSetting) {
                case 1:
                    return 1;
                case 2:
                    return 2;
