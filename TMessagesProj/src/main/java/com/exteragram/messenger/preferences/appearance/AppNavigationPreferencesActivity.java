...
public class AppNavigationPreferencesActivity extends BasePreferencesActivity {
    ...
    private void initItemDetails() {
        ...
        ExteraConfig.mainMenuHiddenItems.removeIf(new Predicate() { // from class: com.exteragram.messenger.preferences.appearance.AppNavigationPreferencesActivity$$ExternalSyntheticLambda6
    ...
    public View createView(Context context) {
        ...
        this.resetItem.setOnClickListener(new View.OnClickListener() { // from class: com.exteragram.messenger.preferences.appearance.AppNavigationPreferencesActivity$$ExternalSyntheticLambda7
            ...
            public final void onClick(View view) {
                AppNavigationPreferencesActivity.this.lambda$createView$1(view);
            }
        });
    ...
    private UItem createMenuItem(int i, ItemInfo itemInfo) {
        ...
        if (i <= -2000 || i == ExteraConfig.MainMenuItem.DIVIDER.id) {
            asButton = UItem.asButton(i, R.drawable.msg_block, LocaleController.getString(R.string.MainMenuDivider));
        } else {
            if (itemInfo == null) {
                return null;
            }
            asButton = UItem.asButton(i, itemInfo.iconRes, itemInfo.name);
        }
        asButton.object2 = this.reorderIcon;
        return asButton;
    }
    ...
    public void updateConfigFromReorder(int i, ArrayList arrayList) {
        ...
        if (i == 0) {
            ...
            if (ExteraConfig.BottomNavigationBar.hidden()) {
                Integer valueOf = Integer.valueOf(ExteraConfig.MainMenuItem.SETTINGS.id);
    ...
    protected void onClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        int i2 = uItem.id;
        AppNavigationItem fromId = AppNavigationItem.fromId(i2);
        int i3 = 0;
        if (fromId != null) {
            switch (AnonymousClass1.$SwitchMap$com$exteragram$messenger$preferences$appearance$AppNavigationPreferencesActivity$AppNavigationItem[fromId.ordinal()]) {
                case 1:
                ...
                case 3:
                    showListDialog(uItem, this.bottomNavigationModes, LocaleController.getString(R.string.BottomNavigationBarMode), ExteraConfig.BottomNavigationBar.getMode(), new PopupUtils.OnItemClickListener() { // from class: com.exteragram.messenger.preferences.appearance.AppNavigationPreferencesActivity$$ExternalSyntheticLambda2
                        ...
                        public final void onClick(int i4) {
                            AppNavigationPreferencesActivity.this.lambda$onClick$4(i4);
                        }
                    });
                    break;
                case 4:
                ...
                case 6:
                    showListDialog(uItem, this.tabletMode, LocaleController.getString(R.string.TabletMode), ExteraConfig.tabletMode, new PopupUtils.OnItemClickListener() { // from class: com.exteragram.messenger.preferences.appearance.AppNavigationPreferencesActivity$$ExternalSyntheticLambda5
                        @Override // com.exteragram.messenger.utils.ui.PopupUtils.OnItemClickListener
                        public final void onClick(int i4) {
                            AppNavigationPreferencesActivity.this.lambda$onClick$7(i4);
                        }
                    });
                    break;
            }
        ...
        if (i2 <= -2000) {
            int indexOf = this.stableDividerIds.indexOf(Integer.valueOf(i2));
            if (indexOf != -1) {
                int i5 = 0;
                while (true) {
                ...
                if (i3 != -1) {
                    this.stableDividerIds.remove(indexOf);
    ...
    /* renamed from: com.exteragram.messenger.preferences.appearance.AppNavigationPreferencesActivity$1, reason: invalid class name */
    ...
    /* renamed from: $r8$lambda$u07TReZ5mBL6eLs-_1kcuhUW0_k, reason: not valid java name */
    ...
    private void updateResetButtonVisibility() {
        ...
        boolean equals = ExteraConfig.mainMenuLayout.equals(ExteraConfig.getDefaultMainMenuLayout());
        if (!equals && this.resetItem.getVisibility() == 8) {
            AndroidUtilities.updateViewVisibilityAnimated(this.resetItem, true, 0.5f, true);
        } else if (equals && this.resetItem.getVisibility() == 0) {
    ...
    private void resetToDefault() {
        ...
        for (ExteraConfig.MainMenuItem mainMenuItem : ExteraConfig.MainMenuItem.values()) {
            if (mainMenuItem != ExteraConfig.MainMenuItem.DIVIDER && !ExteraConfig.mainMenuLayout.contains(Integer.valueOf(mainMenuItem.id))) {
