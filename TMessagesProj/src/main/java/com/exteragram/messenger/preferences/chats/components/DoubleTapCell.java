...
public class DoubleTapCell extends LinearLayout implements CustomPreferenceCell {
    ...
    public DoubleTapCell(final Context context) {
        ...
        this.messages = new MessageDrawable[]{new MessageDrawable(0, false, false), new MessageDrawable(0, true, false)};
    ...
    public void updateIcons(int i, boolean z) {
        ...
        while (i2 < 2) {
            ...
            if (fi2 != 0 || i != 2) {
                if (fi2 != 1 || i != 1) {
                    final int[] doubleTapIcons = DoubleTapUtils.getDoubleTapIcons(fi2 == 1);
                    if (z) {
                        for (int i3 = 0; i3 < 2; i3++) {
                            final int fi3 = i3;
                            this.circleSizeAnimator[fi3] = ValueAnimator.ofFloat(0.0f, 1.0f).setDuration(1300L);
                            long j = fi3;
                            this.circleSizeAnimator[fi3].setStartDelay(60 * j);
                            ValueAnimator valueAnimator = this.circleSizeAnimator[fi3];
                            Interpolator interpolator = Easings.easeInOutQuad;
                            valueAnimator.setInterpolator(interpolator);
                            this.circleSizeAnimator[fi3].addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.exteragram.messenger.preferences.chats.components.DoubleTapCell$$ExternalSyntheticLambda0
                                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                    DoubleTapCell.this.lambda$updateIcons$0(fi3, fi2, valueAnimator2);
                                }
                            });
                            this.circleAnimator[fi3] = ValueAnimator.ofFloat(0.0f, 1.0f).setDuration(700L);
                            this.circleAnimator[fi3].setStartDelay((j * 80) + 150);
                            this.circleAnimator[fi3].setInterpolator(interpolator);
                            this.circleAnimator[fi3].addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.exteragram.messenger.preferences.chats.components.DoubleTapCell$$ExternalSyntheticLambda1
                                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                    DoubleTapCell.this.lambda$updateIcons$1(fi3, fi2, valueAnimator2);
                                }
                            });
                            this.circleAnimator[fi3].addListener(new AnimatorListenerAdapter() { // from class: com.exteragram.messenger.preferences.chats.components.DoubleTapCell.2
                                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                                public void onAnimationEnd(Animator animator) {
                                    super.onAnimationEnd(animator);
                                    DoubleTapCell.this.circleAnimator[fi3].setFloatValues(1.0f, 0.0f);
                                    DoubleTapCell.this.circleAnimator[fi3].setDuration(700L);
                                    DoubleTapCell.this.circleAnimator[fi3].removeAllListeners();
                                    DoubleTapCell.this.circleAnimator[fi3].start();
                                }
                            });
                            this.circleSizeAnimator[fi3].start();
                            this.circleAnimator[fi3].start();
                        }
                        this.animator[fi2] = ValueAnimator.ofFloat(1.0f, 0.0f).setDuration(250L);
                        this.animator[fi2].setInterpolator(Easings.easeInOutQuad);
                        this.animator[fi2].addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.exteragram.messenger.preferences.chats.components.DoubleTapCell$$ExternalSyntheticLambda2
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                DoubleTapCell.this.lambda$updateIcons$2(fi2, valueAnimator2);
                            }
                        });
                        this.animator[fi2].addListener(new AnimatorListenerAdapter() { // from class: com.exteragram.messenger.preferences.chats.components.DoubleTapCell.3
                            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                            public void onAnimationEnd(Animator animator) {
                                super.onAnimationEnd(animator);
                                ...
                                DoubleTapCell.this.animator[fi2].setFloatValues(0.0f, 1.0f);
                                DoubleTapCell.this.animator[fi2].removeAllListeners();
                                DoubleTapCell.this.animator[fi2].addListener(new AnimatorListenerAdapter() { // from class: com.exteragram.messenger.preferences.chats.components.DoubleTapCell.3.1
                                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                                ...
                                DoubleTapCell.this.animator[fi2].start();
                            }
                        });
                        this.animator[fi2].start();
                    } else {
                        this.circleSizeProgress[fi2] = 0.0f;
                        this.circleProgress[fi2] = 0.0f;
                        this.iconChangingProgress[fi2] = 1.0f;
                        this.actionIcon[fi2] = fi2 == 0 ? doubleTapIcons[ExteraConfig.doubleTapAction] : doubleTapIcons[ExteraConfig.doubleTapActionOutOwner];
                        invalidate();
                    }
                }
            }
