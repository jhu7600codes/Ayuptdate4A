...
public class MessagesPreviewCell extends LinearLayout implements CustomPreferenceCell {
    ...
    public MessagesPreviewCell(Context context, INavigationLayout iNavigationLayout, final int i) {
        ...
        if (i == 0) {
            ...
            tL_message3.date = currentTimeMillis - 3480;
            ...
            tL_message4.date = currentTimeMillis - 3540;
            tL_message4.dialog_id = 1L;
            tL_message4.flags = 33027;
            tL_message4.edit_date = currentTimeMillis - 3480;
    ...
    protected void onDraw(Canvas canvas) {
        Drawable cachedWallpaperNonBlocking = Theme.getActiveTheme().isMonet() ? this.monetBackgroundDrawable : Theme.getCachedWallpaperNonBlocking();
