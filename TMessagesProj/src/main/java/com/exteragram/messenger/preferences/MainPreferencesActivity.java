...
public class MainPreferencesActivity extends BasePreferencesActivity {
    ...
    public View createView(Context context) {
        ...
        if (createView instanceof FrameLayout) {
            ((FrameLayout) createView).addView(this.actionBar, LayoutHelper.createFrame(-1, -2.0f));
        }
    ...
    /* renamed from: com.exteragram.messenger.preferences.MainPreferencesActivity$1, reason: invalid class name */
