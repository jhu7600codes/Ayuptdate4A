...
public abstract class StickerShapeCell extends LinearLayout implements CustomPreferenceCell {
        ...
        while (i < 3) {
            ...
            this.stickerShape[i].setOnClickListener(new View.OnClickListener() { // from class: com.exteragram.messenger.preferences.chats.components.StickerShapeCell$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    StickerShapeCell.this.lambda$new$0(fi, view);
                }
            });
            i++;
        }
    ...
    static class StickerShape extends FrameLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            String label = LocaleController.getString(this.isRounded ? R.string.StickerShapeRounded : this.isRoundedAsMsg ? R.string.StickerShapeRoundedMsg : R.string.Default);
            canvas.drawText(label, (getMeasuredWidth() - ((int) Math.ceil(this.textPaint.measureText(label)))) >> 1, AndroidUtilities.dp(102.0f), this.textPaint);
        ...
        private void setProgress(float f) {
            ...
            this.textPaint.setTypeface((f >= 0.5f ? AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM) : android.graphics.Typeface.DEFAULT));
            ...
            if (z2) {
                ...
                duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.exteragram.messenger.preferences.chats.components.StickerShapeCell$StickerShape$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        StickerShapeCell.StickerShape.this.lambda$setSelected$0(valueAnimator);
                    }
                });
                duration.start();
                return;
